...
include { NORMALISE_INTERNAL_DATA       } from "${projectDir}/modules/scanpy-scripts/normalise_internal_data.nf"
include { FIND_VARIABLE_GENES           } from "${projectDir}/modules/scanpy-scripts/find_variable_genes.nf"
include { SCALE_DATA                    } from "${projectDir}/modules/scanpy-scripts/scale_data.nf"
include { RUN_PCA                       } from "${projectDir}/modules/scanpy-scripts/run_pca.nf"
include { HARMONY_BATCH                 } from "${projectDir}/modules/scanpy-scripts/harmony_batch.nf"
include { NEIGHBORS                     } from "${projectDir}/modules/scanpy-scripts/neighbors.nf"
include { NEIGHBORS_FOR_UMAP            } from "${projectDir}/modules/scanpy-scripts/neighbors_for_umap.nf"
include { RUN_TSNE                      } from "${projectDir}/modules/scanpy-scripts/run_tsne.nf"
include { RUN_UMAP                      } from "${projectDir}/modules/scanpy-scripts/run_umap.nf"
include { FIND_CLUSTERS                 } from "${projectDir}/modules/scanpy-scripts/find_clusters.nf"
include { FIND_MARKERS                  } from "${projectDir}/modules/scanpy-scripts/find_markers.nf"

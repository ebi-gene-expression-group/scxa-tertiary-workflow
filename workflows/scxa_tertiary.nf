...
include { SCANPY_READ_10X               } from "${projectDir}/modules/scanpy_read_10x.nf"
include { SCANPY_MULTIPLET_SCRUBLET     } from "${projectDir}/modules/scanpy_multiplet_scrublet.nf"
include { SCANPY_PLOT_SCRUBLET          } from "${projectDir}/modules/scanpy_plot_scrublet.nf"
include { SCANPY_FILTER_CELLS           } from "${projectDir}/modules/scanpy_filter_cells.nf"
include { SCANPY_FILTER_GENES           } from "${projectDir}/modules/scanpy_filter_genes.nf"
include { NORMALISE_DATA                } from "${projectDir}/modules/normalise_data.nf"
include { NORMALISE_INTERNAL_DATA       } from "${projectDir}/modules/normalise_interanl_data.nf"
include { FIND_VARIABLE_GENES           } from "${projectDir}/modules/find_variable_genes.nf"
include { SCALE_DATA                    } from "${projectDir}/modules/scale_data.nf"
include { RUN_PCA                       } from "${projectDir}/modules/run_pca.nf"
include { HARMONY_BATCH                 } from "${projectDir}/modules/harmony_batch.nf"
include { NEIGHBORS                     } from "${projectDir}/modules/neighbors.nf"
include { NEIGHBORS_FOR_UMAP            } from "${projectDir}/modules/neighbors_for_umap.nf"
include { RUN_TSNE                      } from "${projectDir}/modules/run_tsne.nf"
include { FIND_CLUSTERS                 } from "${projectDir}/modules/find_clusters.nf"
include { RESTORE_UNSCALED              } from "${projectDir}/modules/restore_unscaled.nf"
include { FIND_MARKERS                  } from "${projectDir}/modules/find_markers.nf"
